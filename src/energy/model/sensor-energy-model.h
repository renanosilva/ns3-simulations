...
#ifndef SENSOR_ENERGY_MODEL_H
#define SENSOR_ENERGY_MODEL_H
 ...
 * \ingroup energy
 *
 * Modela o consumo de um determinado sensor, quando este realiza alguma leitura.
 *
 */
class SensorEnergyModel : public DeviceEnergyModel
{
  public:
    /**
