...
void CheckpointApp::configureCheckpointStrategy() {
    ...
    } else if (checkpointStrategyName == "EfficientAssyncRecoveryProtocolWithoutRollbackV2") {
...
void CheckpointApp::replayReceive(Ptr<MessageData> md, bool replayResponse, bool resendResponse){
