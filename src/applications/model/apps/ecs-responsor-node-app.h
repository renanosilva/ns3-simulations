...
#ifndef ECS_RESPONSOR_NODE_APP_H
#define ECS_RESPONSOR_NODE_APP_H
 ...
 * \brief Aplicação referente a um nó que recebe requisições e as responde. Utilizado em cenários
 * com utiilzação de ECS.
 */
class ECSResponsorNodeApp : public ECSCheckpointApp {
