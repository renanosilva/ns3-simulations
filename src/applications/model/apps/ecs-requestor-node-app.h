...
#ifndef ECS_REQUESTOR_NODE_APP_H
#define ECS_REQUESTOR_NODE_APP_H
 ...
 * \brief Aplicação referente a um nó que envia requisições e aguarda resposta. Utilizado em cenários com 
 * utilização de ECS.
 */
class ECSRequestorNodeApp : public ECSCheckpointApp
{
  private:
