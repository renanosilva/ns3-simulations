...
#include "no-rollback-2-optimized.h"
...
void EARPWithoutRollbackV2Optimized::writeCheckpoint() {
    ...
    if (!app->hasEnoughEnergyToCheckpoint()){
...
void EARPWithoutRollbackV2Optimized::doWriteCheckpoint() {
...
void EARPWithoutRollbackV2Optimized::beforeBatteryDischarge(){
    NS_LOG_FUNCTION(this);
