...
//O exemplo 6 foi modificado para incluir a geração de vários arquivos de log
//e até a geração automática de um gráfico.
//Para gerar a imagem, após a execução deste script, basta executar o código
//na linha de comando:
...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("useIpv6", "Use Ipv6", useV6); //incluindo a possibilidade de uso do IPV6
    cmd.Parse(argc, argv);
    ...
    {
		//Configurações para uso do IPV6
