...
main(int argc, char* argv[])
{
	...
	//A simulação gera arquivos trace no diretório principal do Ns3
	//Os resultados do console mostram apenas logs do cliente e servidor. Porém os pacotes também passam pelos outros nós.
