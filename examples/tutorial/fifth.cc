...
/* 
Este exemplo mostra como registrar logs de um procedimento interno do Ns3, no caso,
exibir alterações em uma janela de congestionamento do protocolo TCP.
*/
...
main(int argc, char* argv[])
{
    ...
    em->SetAttribute("ErrorRate", DoubleValue(0.00001)); //taxa de erros que irão ocorrer no canal
	...
	//para gerar gráficos, rodar os comandos:
